...
if ($_POST['action'] == 'infoProducto')
  {
    ...
    $query = mysqli_query($conection, "SELECT codproducto, descripcion, existencia, precio, descuento
      FROM producto 
...
if ($_POST['action'] == 'addProduct')
  {
    if (!empty($_POST['precio']) || !empty($_POST['producto_id']))
    {
      $precio = $_POST['precio'];
      $producto_id = $_POST['producto_id'];
      $usuario_id = $_SESSION['idUser'];

      $query_insert = mysqli_query($conection,"INSERT INTO entradas(codproducto,precio,usuario_id)
        VALUES($producto_id,$precio,$usuario_id)");
      if ($query_insert){
        //PROCEDIMIENTO ALMACENADO
        $query_upd = mysqli_query($conection,"CALL descuento_producto($precio,$producto_id)");
        ...
        while ($data = mysqli_fetch_assoc($query_detalle_temp)) {
                ...
                $detalleTabla .='<tr>
                      ...
                      <td>
                          ...
                          del_product_detalle('.$data['correlativo'].');"><i class="fa fa-trash" aria-hidden="true"></i> Eliminar</a>
                      </td>
                </tr>';
                }
