...
<head>
    ...
    <link rel="stylesheet" href="../libreria/css/select2.css">
    ...
    <link rel="stylesheet" href="../libreria/css/all.min.css"><!-- fontawesome -->

    <!-- js -->

    <script src="../libreria/alertifyjs/alertify.js"></script>
    <script src="../libreria/js/select2.js"></script>
    <script src="../libreria/js/j_proveedor.js"></script>
    <script src="../libreria/js/envio_datos_proveedor.js"></script>
