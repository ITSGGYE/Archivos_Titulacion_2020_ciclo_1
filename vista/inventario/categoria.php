        ...
        <div class="row justify-content-around">
            <div class="col-9" id="aqui">
                ...
                <table class="table  table-hover small  table-sm table-responsive" style="height: 75vh; ">
                    ...
                    <thead class="bg-light ">
                        <!-- clases para thead: thead-light or thead-dark -->
                        <tr>
                            <th># </th>
                            <th>Nombre </th>
                            <th style="width: 10vw;">FechaRegistro</th>
                            <th style="width: 10vw;">HoraRegistro</th>
                    ...
                    ?>
                        <tbody>
                            <tr>
                                <th><?php echo 'Cate' . $registro["0"]; //id
                                    ?></th>
            ...
            <div class=" " style="margin-top: 10vh;">
                <select name="" id="buscador_vivo" class="form-control">
                    ...
                    <?php session_start();
                    foreach ($categorias2 as $registro) : ?>
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    <li class="page-item  <?php echo $_GET['p1'] <= 1 ? 'disabled' : ''; ?>"><a class="page-link paginacion_retro" href="CategoriaC.php?p1=<?php echo $_GET['p1'] - 1; ?>">Anterior</a></li>
                    <li class="page-item  <?php echo $_GET['p1'] <= 1 ? 'disabled' : ''; ?>"><a class="page-link paginacion_retro" href="CategoriaC.php?p1=<?php echo 1; ?>">Inicio</a></li>
                    <li class="page-item  <?php echo $_GET['p1'] >= $cantidad_paginacion ? 'disabled' : ''; ?>"><a class="page-link" href="CategoriaC.php?p1=<?php echo $_GET['p1'] + $cantidad_paginacion - 1; ?>">ultimo</a></li>
                    <li class="page-item  <?php echo $_GET['p1'] >= $cantidad_paginacion ? 'disabled' : ''; ?>"><a class="page-link" href="CategoriaC.php?p1=<?php echo $_GET['p1'] + 1; ?>">Siguiente</a></li>
                </ul>
            </nav>
        </div>
    </div>

    <!-- modal para agregar nuevo categoria  -->
