...
?>
<?php require_once '../vista/fragmentos/cabeza_seccion.php'; ?>
        ...
        <div class="row justify-content-around">
                ...
                <table class="table  table-hover small  table-sm table-responsive" style="height: 75vh; ">
                    ...
                    <thead class="bg-light ">
                        ...
                        <tr>
                            <th># </th>
                            <th>Nombre </th>
                            <th style="width: 18vw;">FechaRegistro</th>
                            <th style="width: 18vw;">HoraRegistro</th>
                    ...
                    ?>
                        <tbody>
                            <tr>
                                <th><?php echo 'Secco' . $registro["0"]; //id
                                    ?></th>
            ...
            <div class=" " style="margin-top: 10vh;">
                <select name="" id="buscador_vivo" class="form-control">
                    ...
                    <?php session_start();
                    foreach ($secciones2 as $registro) : ?>
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination">
                    <li class="page-item  <?php echo $_GET['p2'] <= 1 ? 'disabled' : ''; ?>"><a class="page-link paginacion_retro" href="SeccionC.php?p2=<?php echo $_GET['p2'] - 1; ?>">Anterior</a></li>
                    <li class="page-item  <?php echo $_GET['p2'] <= 1 ? 'disabled' : ''; ?>"><a class="page-link paginacion_retro" href="SeccionC.php?p2=<?php echo 1; ?>">Inicio</a></li>
                    <!-- <?php for ($i = 0; $i < $cantidad_paginacion; $i++) : ?> 
                            <li class="page-item <?php echo $_GET['p2'] == $i + 1 ? 'active' : ''  ?> "><a class="page-link paginacion" href="Inventario.php?p=<?php echo $i + 1; ?>"><?php echo $i + 1; ?></a></li>
                        <?php endfor ?> -->
                    <li class="page-item  <?php echo $_GET['p2'] >= $cantidad_paginacion ? 'disabled' : ''; ?>"><a class="page-link" href="SeccionC.php?p2=<?php echo $_GET['p2'] + 1; ?>">Siguiente</a></li>
                </ul>
            </nav>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Guardar nueva Seccion</h5>
