        ...
        <div class="row ">
            <div class="col-12" id="aqui">
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <li class="page-item  <?php echo $_GET['p1'] <= 1 ? 'disabled' : ''; ?>"><a class="page-link paginacion_retro" href="ProductoEntradaC.php?p1=<?php echo $_GET['p1'] - 1; ?>">Anterior</a></li>
                        <li class="page-item  <?php echo $_GET['p1'] <= 1 ? 'disabled' : ''; ?>"><a class="page-link paginacion_retro" href="ProductoEntradaC.php?p1=<?php echo 1; ?>">Inicio</a></li>
                        <li class="page-item  <?php echo $_GET['p1'] >= $cantidad_paginacion ? 'disabled' : ''; ?>"><a class="page-link" href="ProductoEntradaC.php?p1=<?php echo $_GET['p1'] + $cantidad_paginacion -1; ?>">ultimo</a></li>
                        <li class="page-item  <?php echo $_GET['p1'] >= $cantidad_paginacion ? 'disabled' : ''; ?>"><a class="page-link" href="ProductoEntradaC.php?p1=<?php echo $_GET['p1'] + 1; ?>">Siguiente</a></li>
                        <li class="page-item "><a class="page-link" href="ProductoSalidaC.php">Continuar</a></li>
                        <h6><strong>Entrada De Mercaderia</strong></h6>
                    </ul>
                </nav>
            </div>
                    ...
                    <form name="actualizar_productos" id="actualizar_productos" method="post" enctype="multipart/form-data">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>                                    
                                    <input type="text" name="id_u3" id="id_u3" class="form-control input entrada_producto">
                                </td>
                            </tr>
                            <tr>
                                <td><label>Nombre:&nbsp</label></td>
