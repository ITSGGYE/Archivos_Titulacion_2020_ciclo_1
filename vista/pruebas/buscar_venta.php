        ...
        <div class="contenido">
            <div id="aqui">
                ...
                <table class="table table-sm" style="height: auto; ">
                    ...
                    <?php
                    // paginacion        
                    $sql_register = mysqli_query($cn, "SELECT COUNT(*) as total_registros FROM factura WHERE $where");
            ...
            <div style="margin-left: 0px; padding-left: 0px">
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination pagination-sm justify-content-end">
                        ...
                        <li class="page-item  <?php echo $pagina <= 1 ? 'disabled' : ''; ?>"><a class="page-link paginacion_retro" href="?p=<?php echo $pagina - 1; ?>&<?php echo $buscar; ?>">Anterior</a></li>
                        <li class="page-item  <?php echo $pagina <= 1 ? 'disabled' : ''; ?>"><a class="page-link paginacion_retro" href="?p=<?php echo 1; ?>&<?php echo $buscar; ?>">Inicio</a></li>
                        <li class="page-item  <?php echo $pagina >= $totaL_paginas ? 'disabled' : ''; ?>"><a class="page-link" href="?p=<?php echo $totaL_paginas; ?>&<?php echo $buscar; ?>">Ultimo</a></li>
                        <li class="page-item  <?php echo $pagina >= $totaL_paginas ? 'disabled' : ''; ?>"><a class="page-link" href="?p=<?php echo $pagina + 1; ?>&<?php echo $buscar; ?>">Siguiente</a></li>
