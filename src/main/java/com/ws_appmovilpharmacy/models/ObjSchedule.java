...
public class ObjSchedule {
	  ...
	  private int vstOnComplete;
	  private String vstFecSchedule;
	  private String vstDateID;
	  private String vstTitNom;
	  private int vstIsResult;
	  
	public ObjSchedule() {
		super();
	}

	public ObjSchedule(String vstVendCod, String vstFecReg, String vstCliCod, String vstTipe, String vstObs,
			String vstCliDirCod, String vstCliDirNom, String vstCliDirDet, double vstLattd, double vstLogtd,
			double vstDistanceFromDir, int vstOnSite, int vstOnComplete, String vstFecSchedule, String vstDateID,
			String vstTitNom, int vstIsResult) {
		super();
		...
		this.vstOnComplete = vstOnComplete;
		this.vstFecSchedule = vstFecSchedule;
		this.vstDateID = vstDateID;
		this.vstTitNom = vstTitNom;
		this.vstIsResult = vstIsResult;
	}
	...
	public String getVstCliDirCod() {
		return vstCliDirCod;
	}

	public void setVstCliDirCod(String vstCliDirCod) {
		this.vstCliDirCod = vstCliDirCod;
	}
	...
	public int getVstOnComplete() {
		return vstOnComplete;
	}

	public void setVstOnComplete(int vstOnComplete) {
		this.vstOnComplete = vstOnComplete;
	}

	public String getVstFecSchedule() {
		return vstFecSchedule;
	}

	public void setVstFecSchedule(String vstFecSchedule) {
		this.vstFecSchedule = vstFecSchedule;
	}

	public String getVstDateID() {
		return vstDateID;
	}

	public void setVstDateID(String vstDateID) {
		this.vstDateID = vstDateID;
	}

	public String getVstTitNom() {
		return vstTitNom;
	}

	public void setVstTitNom(String vstTitNom) {
		this.vstTitNom = vstTitNom;
	}

	public int getVstIsResult() {
		return vstIsResult;
	}

	public void setVstIsResult(int vstIsResult) {
		this.vstIsResult = vstIsResult;
	}
