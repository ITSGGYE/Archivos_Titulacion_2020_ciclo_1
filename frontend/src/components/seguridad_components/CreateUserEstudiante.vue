        ...
        <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-11 ">
                                <div class="card shadow my-5">
                                    ...
                                    <hr class="my-0">
                                        <div v-if="verificacion == false" class="card-body p-1">
                                            <form method="POST" @submit.prevent="generar_codigo" class="block">
                                            <br>
                                                    <div class="row px-5">
                                                         <div class="col-12 justify-content-center">
                                                           <div class="form-group">/
                                                            <label class="text-600  h5" for="id_username"> Crear usuario <span style="color:#3E9F35;"> <strong>Estudiante</strong> </span></label>
                                                            </div>
                                                         </div>
                                                        <br>
                                                         ...
                                                         <div class="col-6">
                                                             ...
                                                             <div class="form-group">
                                                                 ...
                                                                 <input  id="contra" v-model="contra_validar" @change="confirPassword" :class="[cnf_contra]" class="form-control" required="required"  name="contra" type="password" placeholder="Confirmar contraseña" autocomplete="off">
                                                            </div>
                                                ...
                                                <br>
                                                    <div class="row justify-content-center">
                                                         <div class="col-4">
                                                            <button type="submit" class="btn btn-success btn-block lift" > <strong> Guardar </strong>  </button>
                                                         </div>
                                                         <div class="col-4">
                                                              <button type="button" v-on:click="inciar_sesion" style="background-color: #919191;" class="btn btn-block lift text-light" > <strong> Cancelar </strong>  </button>
                                                         </div>
                                                    </div>
                                            </form>
                                        </div>
                                        <div class="card-body p-1" v-if="verificacion==true">
                                            <div class="row justify-content-center">
                                                <div class="col-12">
                                                    <h4 class="strong">Para finalizar la creacion de su cuenta ingrese el codigo de verificacion.</h4>
                                                </div>
                                                <div class="col-7">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-7">
                                                    ...
                                                    <button @click="mostrar=true" class="bg-naranja lift btn btn-block text-light">Cancelar</button>
                                                </div>
                                            </div>
                                            </center>
