...
<div wire:ignore.self id="createModal" class="modal fade" style="display: none;" aria-hidden="true">
                    ...
                    <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-md-6 offset-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="file" wire:model="foto" id="fileInputId">
                                            @error('foto')
                                            ...
                                            @if ($foto and !$errors->has('foto') and !$editar)
                                                <h6> vista previa:</h6>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-2">
                                <br/>
                                <button class="btn btn-primary btn-group-sm" wire:click.prevent="agregarRepresentante">agregar representante</button>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button
                                                    ...
                                                    wire:click.prevent="eliminarRepresentante({{$loop->index}})" class="btn btn-danger btn-sm">
                                                    Eliminar
                                                </button>
                                            </td>
                                        </tr>
    ...
    <script>
        window.addEventListener('limpiarFoto', event => {
