		...
		<table id="factura_head">
			<tr>
				<td class="logo_factura">
					<div>
						<img src="img/logos.png" style="width: 200px; height: 200px;">
					</div>
				</td>
				<td class="info_empresa">
					...
					?>
						<div>
							<span class="h2"><?php echo strtoupper($informacion['nombre']); ?></span>
							<p><?php echo $informacion['razon_social']; ?></p>
							<p><?php echo $informacion['direccion']; ?></p>
							<p>RUC: <?php echo $informacion['ruc']; ?></p>
							<p>Teléfono: <?php echo $informacion['telefono']; ?></p>
							<p>Email: <?php echo $informacion['email']; ?></p>
						</div>
					<?php
					}
					?>
