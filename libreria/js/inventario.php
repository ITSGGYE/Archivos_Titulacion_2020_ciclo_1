    ...
    <div class="container-fluid">
        ...
        <div class="row ">
            <div class="col-10" id="aqui">
                ...
                <table class="table  table-hover small  table-sm table-responsive" style="height: 78vh; ">
                    ...
                    ?>
                        <tbody>
                            <tr>
                                <th><?php echo 'Produc' . $registro["0"]; //id?></th>
                                <td><?php echo $registro["1"]; //nombre?></td>
                                <td><?php echo $registro["2"]; //marca?></td>
                                <td><?php echo $registro["3"]; //precio?></td>
                                <td><?php echo $registro["4"]; //stock?></td>
                                <?php session_start();  $_SESSION['aqui'] = $registro['4'];   ?>
                                <td><?php echo $registro["5"]; //fecha?></td>
                                <td><?php echo $registro["6"]; //hora?></td>
                                <td><?php echo $registro["7"]; //proveedor?></td>
                                <td><?php echo $registro["8"]; //categoria?></td>
                                <td><?php echo $registro["9"]; //seccion?></td>
                                <td><?php echo $registro["10"]; //descripcion?></td>
                                <!-- imagen -->
            ...
            <div class=" "  style="margin-top: 20vh;">                
                <select name="" id="buscador_vivo" class="form-control">
                    ...
                    <option value="<?php echo $_SESSION['id_comprovante'] = $registro[0]; ?>">
                        ...
                        $registro[3] /* por precio */ .' '. $registro[4] /* por stock */;  endforeach ?>
                    </option>
                </select>
            </div>
            <!-- paginador -->
                                ...
                                <td>
                                    <select name="proveedor_i" class="form-control entrada_producto" id="proveedor_i">
                                        <?php foreach ($proveedores as $registro) : ?>
                                            <option value="<?php echo $registro['0']; ?>"><?php echo $registro['1']; endforeach ?></option>
                                    </select>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="categoria_u" class="form-control entrada_producto" id="categoria_u">                                    
                                        <?php foreach ($categorias as $registro) : ?>                                                                                        
                                            <option  value="<?php echo $registro['0']; ?>" selected><?php echo $registro['1']; endforeach ?></option>
                                    </select>
                ...
                <div class="modal-body small">
                    <form name="actualizar_productos_u" id="actualizar_productos_u" method="post" enctype="multipart/form-data">
                        <table>
                            ...
                            <tr>
                                <td><label>Stock:&nbsp</label></td>
                                <td><input type="number" min=""  max="" name="stock_u2" id="stock_u2" class="form-control input entrada_producto" value=""></td>
                            </tr>
                        </table>
                    </form>
                </div>
