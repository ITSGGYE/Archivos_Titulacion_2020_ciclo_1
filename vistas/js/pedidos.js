     ...
     $.ajax({
     	...
     	url:"ajax/productos.ajax.php",
      	...
      	success:function(respuesta){
          	...
          	var precio = respuesta["precio_pedido"];
	  ...
	  $.ajax({
     	...
     	url:"ajax/productos.ajax.php",
      	...
      	success:function(respuesta){
      	    ...
      	    $(nuevoPrecioProducto).val(respuesta["precio_pedido"]);
      	    $(nuevoPrecioProducto).attr("precioReal", respuesta["precio_pedido"]);
...
function agregarImpuesto(){
	...
	var impuesto = $("#nuevoImpuestoPedido").val();
	...
	$("#nuevoTotalPedido").val(totalConImpuesto);
...
$("#nuevoImpuestoPedido").change(function(){
...
$(".formularioPedido").on("change", "input#nuevoValorEfectivo", function(){
	...
	var cambio =  Number(efectivo) - Number($('#nuevoTotalPedido').val());
...
CAMBIO TRANSACCIÓN
=============================================*/
$(".formularioPedido").on("change", "input#nuevoCodigoTransaccion", function(){
