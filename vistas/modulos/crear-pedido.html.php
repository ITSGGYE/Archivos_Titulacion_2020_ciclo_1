              ...
              <div class="box">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="nuevoSecretaria" name="nuevoSecretaria" value="Usuario Administrador" readonly>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="nuevoPedido" name="nuevoPedido" value="10002343" readonly>
                        ...
                        <tr>
                          ...
                          <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" class="form-control" min="0" id="nuevoImpuestoPedido" name="nuevoImpuestoPedido" placeholder="0" required>
